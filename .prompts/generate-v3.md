...
Brand:
Soho Properties is a real estate company in Bangkok with the slogan "Bangkok's finest property listing website". They offer buying, selling, and renting residential (condos, apartments, houses, townhouses, villas) and commercial (offices, shops, warehouses, hotels/resorts) properties, including investment and pet-friendly options. Their main customers are foreigners/expats, investors, and renters in Bangkok. Key features include expertise in Bangkok's real estate market, neighborhood guides, and Hot Properties. They want a primarily English website (with Thai support) with a professional, premium, trustworthy, and easy-to-use aesthetic. The site should emphasize property search and listings with beautiful photos, include a search page, property detail pages, and contact forms. Contact info: Phone +66 815 516 695, Address 19/148 14th Floor Sukhumvit Suite, Sukhumvit Soi 13, Klongtoey, Bangkok 10110. Open Mon-Fri 9:00-18:00. They also have Facebook, Twitter, and LINE.

This is variant 3 of 3.

CREATIVE DIRECTION
A creative director has chosen this direction for variant #3:
Dense information-forward masonry grid with overlapping property cards, bold typographic hierarchy — compressed grotesque headline font at display scale, monospaced data labels for prices/specs — warm graphite (#2D2926) + pale amber (#F2E0C0) + sage grey (#8B9E8E) + bright white (#FFFFFF) — energetic, metropolitan, data-confident without feeling cold
