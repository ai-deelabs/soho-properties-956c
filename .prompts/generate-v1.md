...
Asymmetric split-screen grid with full-bleed property photography bleeding into text columns — oversized condensed sans-serif headlines with tight tracking, body in elegant light-weight serif — deep charcoal (#1C1C1E) + warm sand (#D4C5A9) + muted terracotta (#B5735A) + off-white (#F5F0E8) — composed, editorial, quietly authoritative
